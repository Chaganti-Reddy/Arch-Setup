...
sudo pacman -S acpilight cabal-install ccls haskell-language-server hoogle qt5ct kvantum-qt5 pass rofi-pass php pwgen python-black python-pyflakes python-isort python-pipenv python-pytest shellcheck slock trayer volumeicon nim ncdu mlocate inotify-tools
