...
#yay -S  protonvpn filezilla pamac-all obsidian sublime-text-4 betterlockscreen-git gromit-mpx lightdm-webkit2-greeter  appimagelauncher-git newsflash mu mbsync-git newsflash newsflash
