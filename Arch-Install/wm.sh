...
# sudo pacman -S xfce4-terminal zsh xfce4-power-manager feh cronie r lightdm kitty i3-gaps jq volumeicon
sudo pacman -S acpilight cabal-install ccls haskell-language-server hoogle qt5ct kvantum-qt5 pass rofi-pass php pwgen python-black python-pyflakes python-isort python-pipenv python-pytest shellcheck slock trayer nim ncdu mlocate inotify-tools dash mplayer
