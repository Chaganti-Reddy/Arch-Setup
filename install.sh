...
# paru -S material-black-colors-theme kvantum-theme-materia apple_cursor kvantum --noconfirm
...
# paru -S wlrobs-hg  clipse-bin hyde-cli-git wlogout hyprshot-git hyprland-qtutils-git
# sudo pacman -S wofi
