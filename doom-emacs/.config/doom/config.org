##+TITLE: Ram's Doom Emacs Config
#+AUTHOR: Ram (ArcaneSeal)
#+DESCRIPTION: RAM's personal Doom Emacs config.
...
- [[#evil-multi-edit][EVIL MULTI EDIT]]
- [[#neotree][NEOTREE]]
...
* DASHBOARD
Emacs Dashboard is an extensible startup screen showing you recent files, bookmarks, agenda items and an Emacs banner. If you Want to use default dashboard then just uncomment doom-dashboard in int.el and comment these.
...
* GITHUB COPILOT
Copilot.el is an Emacs plugin for GitHub Copilot. https://github.com/copilot-emacs/copilot.el
...
* EVIL MULTI EDIT
Evil-multiedit is a multiple cursors package for evil-mode.  It is a package that allows you to select multiple instances of a word or phrase and edit them all at once.
...
| ~/dotfiles/Org/Org/agenda.org | /Edit agenda file/            | SPC = a    |
...
(map! :leader
      (:prefix ("=" . "open file")
       ...
       :desc "Edit agenda file"      "a" #'(lambda () (interactive) (find-file "~/dotfiles/Org/Org/agenda.org"))
...
(after! org
  (setq org-directory "~/dotfiles/Org/Org"
...
#+begin_src emacs-lisp
(after! org
  (setq org-agenda-files '("~/dorfiles/Org/Org/agenda.org")))
...
** Org Download
using this we can directly paste images from clipboard which will save those images to a relative path directory to the current file
...
** Org-journal
#+begin_src emacs-lisp
(setq org-journal-dir "~/dotfiles/Org/Org/journal/"
...
(setq org-publish-project-alist
      '(("distro.tube without manpages"
         :base-directory "~/dotfiles/Org/Org/publish/"
         :base-extension "org"
         :publishing-directory "~/dotfiles/Org/Org/publish/html/"
         :recursive t
         ...
         :auto-preamble t)
         ("man0p"
         :base-directory "~/dotfiles/Org/Org/publish/man-org/man0p/"
         :base-extension "org"
         :publishing-directory "~/dotfiles/Org/Org/publish/html/man-org/man0p/"
         :recursive t
         :publishing-function org-html-publish-to-html
         :headline-levels 4             ; Just the default for this project.
         :auto-preamble t)
...
#+begin_src emacs-lisp
(after! org
  (setq org-roam-directory "~/dotfiles/Org/Org/roam/"
