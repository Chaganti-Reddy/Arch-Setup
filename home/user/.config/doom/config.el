...
(map! :leader
      (:prefix ("o")
       :desc "Open Calendar"  "C" #'dt/year-calendar))
...
;;   (setq dashboard-startup-banner "~/.config/doom/images/emacs-dash.png")  ;; use custom image as banner
...
(setq org-journal-dir "~/dotfiles/Org/journal/"
...
(setq org-publish-project-alist
      '(("distro.tube without manpages"
         :base-directory "~/dotfiles/Org/publish/"
         :base-extension "org"
         :publishing-directory "~/dotfiles/Org/publish/html/"
         :recursive t
         ...
         :auto-preamble t)
         ("man0p"
         :base-directory "~/dotfiles/Org/publish/man-org/man0p/"
         :base-extension "org"
         :publishing-directory "~/dotfiles/Org/publish/html/man-org/man0p/"
         :recursive t
         :publishing-function org-html-publish-to-html
         :headline-levels 4             ; Just the default for this project.
         :auto-preamble t)
