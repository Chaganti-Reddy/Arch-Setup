...
vim.g.vimtex_general_options = '-reuse-instance -forward-search @tex @line @pdf"'
vim.g.vimtex_general_options_latexmk = '-reuse-instance'
...
vim.g.vimtex_compiler_latexmk = {
  ...
  options = {
    "-pdf",
    "-outdir=" .. vim.fn.expand "%:p:h" .. "/build",
...
vim.api.nvim_create_autocmd("BufEnter", {
  pattern = { "*.json", "*.jsonc", "*.sh" },
  -- enable wrap mode for json files only
  command = "setlocal wrap",
})

vim.api.nvim_create_autocmd("BufEnter", {
  pattern = { "*.c", "*.cpp", "*.py", "*lua" },
