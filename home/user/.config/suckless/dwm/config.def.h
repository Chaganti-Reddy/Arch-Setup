...
static Key keys[] = {
  ...
  { MODKEY,            			      XK_y,  	   togglescratch,  {.ui = 0 } },
	...
	{ MODKEY,											  XK_F10,	   spawn,		       SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-; dunstify 'Volume Lowered by 5%'")},
	{ MODKEY|ShiftMask,						  XK_F9,	   spawn,		       SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 0%; dunstify 'Volume Muted'")},
	{ MODKEY,											  XK_F11,	   spawn,		       SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+; dunstify 'Volume Raised by 5%'")},
