...
print("You can book from today, which is " +
      str(date_object), "to", str(EndDate))

# booking a date

month = int(
        input('Enter the month you want to book (numbered 01 - 12 respectively)'))
...
if oday_tday == 2:
    while exa > 3 or exa < 0:
        exa = int(
            input("Input here for the above line. Make sure it is 0, 1, 2 or 3."))

if oday_tday == 1:
    while exa > 2 or exa < 0:
        exa = int(
            input("Input here for the above line. Make sure it is 0, 1, or 2."))
...
if scaler < 100 and scaler != 0 and scaler != 1:
    print("It would be cheaper if you bought", scaler - 1,
          "family packs. Press 1 if you want this, press 0 otherwise.")
    offer2 = int(input("..."))
