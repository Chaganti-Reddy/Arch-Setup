...
export PATH=/home/ram/.emacs.d/bin:$PATH
export PATH=/home/ram/R/:$PATH
...
ulimit -s 2000123
echo -ne '\e[1 q' # changes to blinking block
#echo -ne '\e[2 q' # changes to steady block
#echo -ne '\e[3 q' # changes to blinking underline
#echo -ne '\e[4 q' # changes to steady underline
#echo -ne '\e[5 q' # changes to blinking i-beam
#echo -ne '\e[6 q' # changes to steady i-beam

# fnm
FNM_PATH="/home/karna/.local/share/fnm"
if [ -d "$FNM_PATH" ]; then
